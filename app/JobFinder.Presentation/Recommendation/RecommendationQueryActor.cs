      ...
      await HandleQuery (query, uow =>
      {
        ...
        return new GetRecommendedOffersListResult (recommendedOffers
          .Select (ro => new GetRecommendedOffersListResult.RecommendedOfferDto (
            ...
            ro.CertificatesWillBeAnAdvantage,
            ro.RequiredSkills.Select (rs => new SkillDto (rs.Id, rs.Skill.ProfessionId, rs.Skill.Description, rs.Level)),
            ro.WelcomeSkills.Select (ws => new SkillDto (ws.Id, ws.Skill.ProfessionId, ws.Skill.Description, ws.Level)),
            ro.Languages.Select (l => new LanguageDto (l.Id, l.Language.Description, l.Level))
